    ...
    <div className="min-h-screen min-h-[100dvh] bg-slate-950 flex flex-col justify-center items-center p-3.5 sm:p-6 relative overflow-hidden select-none" dir="rtl">
      ...
      <div className="w-full max-w-md bg-slate-900 border border-slate-800 rounded-3xl p-5 sm:p-8 shadow-2xl relative z-10">
        ...
        <div className="text-center mb-6 sm:mb-8">
          ...
          <h1 className="text-xl sm:text-2xl font-bold text-white tracking-tight">ريفيو فلو | ReviewFlow</h1>
          <p className="text-[11px] sm:text-xs text-slate-400 mt-1">منصة أتمتة ونشر تقييمات قنوات التداول والفوركس 24/7</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 rounded-xl bg-emerald-600 hover:bg-emerald-500 active:scale-98 text-white text-xs sm:text-sm font-bold shadow-lg shadow-emerald-950 transition-all flex items-center justify-center gap-2 mt-2"
          >
